...
{
    /// <summary>
    /// This class represents the FPTVContext which is derived from the IdentityDbContext class and is used to manage the user authentication and authorization. 
    /// </summary>
